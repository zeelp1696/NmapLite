...
COMMON_PORT_NAMES = {
    ...
    110: "pop3", 123: "ntp", 135: "msrpc", 137: "netbios-ns", 138: "netbios-dgm",
    139: "netbios-ssn", 143: "imap", 161: "snmp", 162: "snmptrap", 389: "ldap",
    443: "https", 445: "microsoft-ds", 465: "smtps", 514: "syslog", 587: "submission",
...
def grab_banner(ip: str, port: int, timeout: float = 2.0) -> Optional[str]:
    """Minimal, safe banner grabbing for open ports."""
    try:
